...
const faqs = [
  ...
  {
    q: '手続きで自分がやることはありますか？',
    a: 'ほぼありません。お客様にしていただくのは、年に2〜3回の承認ボタンを押すことと、届出通りの金額を振り込むことだけです。書類作成・届出・期限管理はすべて当社が行います。',
  },
  {
    q: '万が一、年金事務所から否認されたらどうなりますか？',
    a: '当社の否認リスク補償（SLA）により、当社のスキームに基づいて運用した場合の否認について、差額保険料と延滞金を全額当社が負担します。お客様のリスクはゼロです。',
  },
  {
    q: '将来もらえる年金が減りませんか？',
